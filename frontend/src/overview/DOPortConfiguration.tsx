...
export default function DOPortConfiguration({ setPrompt }: ContextType) {
                ...
                <div className="modal-body">
                  ...
                  <div className="input-group mt-3">
                    <input
                      ...
                      disabled={newConfiguration.port === -1}
                    />
